...
from voxcpm.infer_onnx import VoxcpmOnnx
...
class VoxCPMDemo:
    def __init__(self) -> None:
        ...
        # TTS model (lazy init)
        self.voxcpm_model: Optional[VoxcpmOnnx] = None
        self.default_local_model_dir = "./checkpoints/ja-jp-large-rev-a-onnx" #"./checkpoints/voxcpm-1.5"
    ...
    def generate_tts_audio(
        ...
        wav, sr = current_model.infer(
            target_text=text,
            prompt_text=prompt_text,
            prompt_audio_path=prompt_wav_path,
            text_normalize=do_normalize,
            audio_normalize=False,  # Denoiser disabled
        )
        return (sr, wav)
